...
const BATCH_POLL_INTERVAL = 30 * 1000; // 30 secs = 30 * 1000ms
class AzHttpClient {
    constructor() {
    ...
    getBatchResponse(policies, method) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let batchResponses = yield this.processBatchRequestAsync(batchRequests);
            // We need to return response in the order of request.
            batchResponses.sort(this.compareBatchResponse);
            return batchResponses;
        });
    }
    processBatchRequestAsync(batchRequests) {
        return __awaiter(this, void 0, void 0, function* () {
            let batchResponses = [];
            let pendingRequests = [];
            ...
            const batchRequestsChunks = utilities_1.splitArray(batchRequests, ASYNC_BATCH_CALL_SIZE);
