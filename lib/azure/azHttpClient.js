...
class AzHttpClient {
    ...
    createOrUpdate(resourceId, payload) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    getPolicyDefinition(definition) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.sendRequest('GET', definition.id, undefined)
                .then((response) => {
                if (response.statusCode == httpClient_1.StatusCodes.OK || response.statusCode == httpClient_1.StatusCodes.NOT_FOUND) {
    ...
    getPolicyAssignment(assignment) {
        return __awaiter(this, void 0, void 0, function* () {
