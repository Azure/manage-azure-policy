...
const ID_DUPLICATE_SUFFIX_2 = utilities_1.getRandomShortString();
...
function startForceUpdate(badRequests, definitionsInService, assignmentsInService, azHttpClient) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            leftoutPolicyIdsInService = yield deletePolicies(assignmentsInService, azHttpClient);
        }
        catch (error) {
        ...
        let roleAssignmentResults = [];
        try {
            [repoDefinitionResponses, repoAssignmentRequests, repoAssignmentResponses] = yield upsertPoliciesFromCode(badRequests, roleAssignmentResults, azHttpClient);
        }
        catch (error) {
 ...
 */
function upsertPoliciesFromCode(definitionRequests, roleAssignmentResults, azHttpClient) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield validateUpsertResponse(definitionResponses, azHttpClient, false);
        const assignmentResponses = yield azHttpClient.upsertPolicyAssignments(assignmentRequests, roleAssignmentResults);
        yield validateUpsertResponse(assignmentResponses, azHttpClient, true);
