    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (badRequests.length > 0) {
            ...
            if (checkAssignmentsExists(badRequests, allDefinitionAssignments)) {
                ...
                const [originalDefinitionResponses, originalAssignmentRequests, originalAssignmentResponses] = yield createOriginalPolicies(badRequests, azHttpClient);
...
function deleteOldPolicies(policyDefinitionIds, policyAssignments, azHttpClient) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let allAssignmentIds = getPolicyIds(policyAssignments);
...
function createOriginalPolicies(definitionRequests, azHttpClient) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let definitionResponses = yield azHttpClient.upsertPolicyDefinitions(definitionRequests);
