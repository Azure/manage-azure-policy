...
function createDuplicateDefinitions(policyRequests, azHttpClient) {
    return __awaiter(this, void 0, void 0, function* () {
        utilities_1.prettyDebugLog(`Creating Duplicate definitions`);
...
function createDuplicateAssignments(policyRequests, azHttpClient) {
    return __awaiter(this, void 0, void 0, function* () {
        utilities_1.prettyDebugLog(`Creating Duplicate assignments`);
...
function deleteOldPolicies(policyDefinitionIds, policyAssignments, azHttpClient) {
    return __awaiter(this, void 0, void 0, function* () {
        utilities_1.prettyDebugLog(`Deleting Assignments`);
        ...
        utilities_1.prettyDebugLog(`Deleting Definitions`);
