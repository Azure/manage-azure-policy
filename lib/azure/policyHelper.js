...
exports.createPoliciesUsingIds = exports.getPolicyAssignment = exports.getPolicyAssignments = exports.createUpdatePolicies = exports.getAllPolicyRequests = exports.FRIENDLY_ASSIGNMENT_TYPE = exports.FRIENDLY_INITIATIVE_TYPE = exports.FRIENDLY_DEFINITION_TYPE = exports.POLICY_INITIATIVE_FILE_NAME = exports.POLICY_FILE_NAME = exports.POLICY_RESULT_SUCCEEDED = exports.POLICY_RESULT_FAILED = exports.POLICY_OPERATION_NONE = exports.POLICY_OPERATION_UPDATE = exports.POLICY_OPERATION_CREATE = exports.ROLE_ASSIGNMNET_TYPE = exports.ASSIGNMENT_TYPE = exports.INITIATIVE_TYPE = exports.DEFINITION_TYPE = void 0;
...
function createUpdatePolicies(policyRequests) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (Inputs.forceUpdate) {
            yield forceUpdateHelper_1.handleForceUpdate(definitionRequests, definitionResponses, assignmentRequests);
        }
        ...
        try {
            ...
            policyDefinitions.forEach((definition, index) => {
                if (definition.error) {
                    ...
                    roleAssignmentResults.push(getRoleAssignmentResult(policyAssignment.path, policyAssignment.id, policyAssignment.properties.policyDefinitionId, exports.POLICY_RESULT_FAILED, message));
                }
                else {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            responses.forEach((response, index) => {
                ...
                let status = exports.POLICY_RESULT_SUCCEEDED;
