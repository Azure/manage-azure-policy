        ...
        try {
            ...
            responses.forEach((response, index) => {
                ...
                if (response.httpStatusCode == httpClient_1.StatusCodes.CREATED) {
                    ...
                    roleAssignmentResults.push(getRoleAssignmentResult(roleRequest.path, roleRequest.policyAssignmentId, roleRequest.policyDefinitionId, exports.POLICY_RESULT_SUCCEEDED, message));
                }
                else {
                    ...
                    roleAssignmentResults.push(getRoleAssignmentResult(roleRequest.path, roleRequest.policyAssignmentId, roleRequest.policyDefinitionId, exports.POLICY_RESULT_FAILED, message));
                }
            });
        }
        catch (error) {
