...
function createUpdatePolicies(policyRequests) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield assignRoles(assignmentRequests, assignmentResponses);
...
function assignRoles(assignmentRequests, assignmentResponses) {
    return __awaiter(this, void 0, void 0, function* () {
        let roleRequests = [];
        ...
        // Test
        utilities_1.prettyDebugLog(`role Requests : ${roleRequests}`);
        utilities_1.prettyDebugLog(`role Requests : ${JSON.stringify(roleRequests)}`);
        yield createRoleRequests(roleRequests);
    });
}
function createRoleRequests(roleRequests) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            responses.forEach((response, index) => {
                if (response.httpStatusCode == httpClient_1.StatusCodes.CREATED) {
                    ...
                    utilities_1.prettyLog(`Role assignment could not be created related to assignment id ${roleRequests[index].policyAssignmentId}. Error : ${response.content.error}`);
                }
                else {
                    utilities_1.prettyLog(`Role assignment could not be created related to assignment id ${roleRequests[index].policyAssignmentId}`);
                }
            });
        }
        catch (error) {
