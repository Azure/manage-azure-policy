...
function assignRoles(assignmentRequests, assignmentResponses, roleAssignmentResults) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (pendingAssignments.length > 0) {
            yield getMissingRoleRequests(pendingAssignments, roleRequests, roleAssignmentResults);
        }
        yield createRoleRequests(roleRequests, roleAssignmentResults);
    });
}
function getMissingRoleRequests(pendingAssignments, roleRequests, roleAssignmentResults) {
    return __awaiter(this, void 0, void 0, function* () {
